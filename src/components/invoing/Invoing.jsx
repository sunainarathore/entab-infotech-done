          ...
          <Grid item xs={6} className="invoing-card-part-grid">
            <Card className="invoing-card-part">
              ...
              <div className="d-flex align-items-center">
                  ...
                  <Heading appearance="success"  style={{color:'rgb(233 17 63)',fontSize:'20px',fontWeight:'600'}}>171.00k</Heading>
                  </Text>
                </div>
          ...
          <Grid item xs={6} className="invoing-card-part-grid">
            <Card className="invoing-card-part">
              ...
              <div className="d-flex align-items-center">
                  <Icon appearance="success" name="arrow_drop_up" size={0} />
                  <Text weight="strong" appearance="success">
                  <Heading appearance="success" style={{fontSize:'20px',fontWeight:'600'}}>1800.00k</Heading>
                  </Text>
                </div>
          ...
          <Grid item xs={6} className="invoing-card-part-grid">
            <Card className="invoing-card-part">
              ...
              <div className="d-flex align-items-center">
                  ...
                  <Heading appearance="Warning" style={{fontSize:'20px',fontWeight:'600'}}>49</Heading>
                  </Text>
                </div>
                <Text className="mb-6"> Invoice Due</Text>
          ...
          <Grid item xs={6} className="invoing-card-part-grid">
            <Card className="invoing-card-part">
              ...
              <div className="d-flex align-items-center">
                  ...
                  <Heading appearance="Alert" style={{fontSize:'20px',fontWeight:'600'}}>54</Heading>
                  </Text>
                </div>
                <Text className="mb-6">All Time Paid</Text>
              </div>
            </Card>
          </Grid>
        </Grid>
